                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="info">
                                        ...
                                        <p><strong>Giá:</strong> <strong class="price"><?php echo number_format ($rows->c_price); ?></strong> <a href="index.php?controller=cart&act=add&id=<?php echo $rows->pk_product_id; ?>"><img src="public/frontend/images/icon-cart.jpg" style="width:10px;" /> Cart</a></p>
                                    </div>
                                </li>
