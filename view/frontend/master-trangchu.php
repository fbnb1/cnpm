    ...
    <!-- begin header -->
    	<div id="header">
            ...
            <div id="top-nav">				
                ...
                <div id="menu">
                	<ul>
                    	<li><a href="#" class="actived"><span>Trang chủ</span></a></li>
            ...
            <div class="search-bar">
            	<form method="get">
                    ...
                    <div class="cart-message">
                    	<a href="#" class="cart"><img src="public/frontend/images/icon-cart.jpg" title="click vào đây để xem giỏ hàng của bạn"></a>
        ...
        <div id="content">        	
            ...
            <?php include "controller/frontend/controller_inc_product.php"; ?>
                ...
                <?php include "controller/frontend/controller_static.php"; ?>
            ...
            <!-- ----------------- -->
                ...
                <?php include "controller/frontend/controller-hot-product.php"; ?>
                <?php include "controller/frontend/controller-new-product.php"; ?>
                <!-- quảng cáo -->
